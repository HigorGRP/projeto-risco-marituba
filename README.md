...
Abaixo está o fluxo lógico de como os dados são processados:
...
Consistência: O uso de Encoders serializados garante que a tradução dos dados na API seja idêntica à do treinamento.
